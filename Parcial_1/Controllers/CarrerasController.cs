...
namespace Parcial1.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Rector,FechaCreacion,Activo")] Carreras carreras)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Rector,FechaCreacion,Activo")] Carreras carreras)
        {
            if (id != carreras.Id)
            {
                return NotFound();
